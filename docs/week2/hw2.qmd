...
fig, ax, A = makefig()
save("hw2_files/figure-html/parta.png", fig)
```
![circle of 100 points centered at the origin](hw2_files/figure-html/parta.png){fig-align="center"
width="70%"}
...
```{julia}
shear = getShear(0.01)
record(fig, "hw2_files/figure-html/shear.mp4", 1:200, framerate = 60) do i
    A[] = A[] * shear
end;
```
<video width="600" autoplay loop muted>
  <source src="hw2_files/figure-html/shear.mp4" type="video/mp4">
</video>
...
record(fig, "hw2_files/figure-html/rotation.mp4", 1:200, framerate = 60) do i
    A[] = A[] * rotation
end;
```
<video width="600" autoplay loop muted>
  <source src="hw2_files/figure-html/rotation.mp4" type="video/mp4">
</video>
...
record(fig, "hw2_files/figure-html/stretch.mp4", 1:200, framerate = 60) do i
    A[] = A[] * stretch
end;
```
<video width="600" autoplay loop muted>
  <source src="hw2_files/figure-html/stretch.mp4" type="video/mp4">
</video>
...
function partD()
    ...
    record(fig, "hw2_files/figure-html/partd.mp4", 1:200, framerate = 60) do i
        A[] = A[] * shear
        B[] = B[] * rotation
        C[] = C[] * stretch
    end;
...
<video width="650" autoplay loop muted>
  <source src="hw2_files/figure-html/partd.mp4" type="video/mp4">
</video>
...
function makefig()
    ...
    save("hw2_files/figure-html/p1partb.png", fig)
end
makefig();
```
![System dynamics with 3 different initial conditions over 10 steps](hw2_files/figure-html/p1partb.png){fig-align="center"
width="100%"}
...
function partc()
    ...
    save("hw2_files/figure-html/q2partc.png", fig)
    return η, [10.0 0.0], [0.0 10.0], [7.0 7.0]
end
η, p1, p2, p3 = partc();
```
![The eigenvectors of the matrix A along with normalized initial conditions](hw2_files/figure-html/q2partc.png){fig-align="center"
width="100%"}
...
function partd(η, p1, p2, p3)
    ...
    save("hw2_files/figure-html/partd.png", fig)
end
partd(η, p1, p2, p3);
```
![Bar plot of the projections of the initial conditions onto the eigen vectors of A.](hw2_files/figure-html/partd.png){fig-align="center"
width="100%"}
